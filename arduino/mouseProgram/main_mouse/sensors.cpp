...
// Define sensor pins and threshold values
...
#define SHORT_RANGE_THRESHOLD   500 // Example value, changed based on sensors
#define LONG_RANGE_THRESHOLD    300

WallStates getWallStates() {
  // Define struct states
  WallStates states;
  ...
  // Use states struct to send bool values
